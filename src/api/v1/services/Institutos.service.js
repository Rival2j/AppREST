...
// SEG: GET INSTITUTES LIST (Obtener todos los institutos)
...
// SEG: GET INSTITUTE BY ID (Obtener un solo instituto por su ID)
...
// SEG: POST (ADD) Instituto/Institutos
...
// SEG: SERVICES PUT
// ----------------------------------------------------------------------
// SEG: PUT (MODIFY) INSTITUTOS
export const putInstitutoItem = async (id, paInstitutoItem) => {
    try {
        // console.log("SEG: PUT API INSTITUTO", id);
