...
// SEG: API GET (Todas las Instituciones)
...
// SEG: API GET (Solo un Instituto por ID)
...
// SEG: API POST.
// ----------------------------------------------------------------------
// SEG: API POST (ADD) Instituto o Institutos (JSON en BODY)
export const postInstitutoItem = async (req, res, next) => {
    try {
        // SEG: Mandamos el body directamente al servicio (puede ser un objeto o un arreglo)
        const institutosAdded = await InstitutosServices.postInstitutoItem(req.body);
        
        // SEG: Validamos usando las banderas de nuestro manejador de respuestas
...
// SEG: API DELETE
// ----------------------------------------------------------------------
// SEG: API DELETE (REMOVE) Instituto.
export const deleteInstitutoItem = async (req, res, next) => {
    try {
        ...
        const { id } = req.params;
        console.log('SEG: controller delete id -> ', id);
